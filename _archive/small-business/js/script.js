...
$.get('/landing/json/yandex-shared-info.json', function(data) {
    ...
    $("#BotsCountY").text(new Intl.NumberFormat('ru-RU').format(BotsCountY));
...
$.get('/landing/json/google-shared-info.json', function(data) {
    var BotsCountG = data["BotsCount"];
    $("#BotsCountG").text(new Intl.NumberFormat('ru-RU').format(BotsCountG));
});
